...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='支付中心订单表;';
...
CREATE TABLE `payment_users` (
                                  `id` int NOT NULL COMMENT '用户主键',
                                  `imooc_user_id` varchar(64) NOT NULL COMMENT '用户在慕课网的用户id',
                                  `password` varchar(64) NOT NULL COMMENT '密码',
                                  `end_date` datetime NOT NULL COMMENT '用户访问有效期',
                                  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='支付中心用户表;';
