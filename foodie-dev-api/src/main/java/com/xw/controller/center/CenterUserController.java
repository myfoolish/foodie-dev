...
import com.xw.resource.FileUpload;
...
public class CenterUserController extends BaseController {
    ...
    public JSONResult update(@RequestParam String userId,
                             @RequestBody @Valid CenterUserBO centerUserBO, // @Valid 开启验证
                             BindingResult result,  // 将错误保存在 BindingResult 中
...
//        userResult = setNullProperty(userResult);
    ...
    public JSONResult updateFace(@RequestParam String userId,
                             MultipartFile file,
                             HttpServletRequest request, HttpServletResponse response) {
        // 定义头像保存的位置
        ...
        if (file != null) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(fileName)) {
                    ...
                    // 文件名名称重组 face-{userId}.png 目前为覆盖式上传  增量式可额外拼接当前时间
